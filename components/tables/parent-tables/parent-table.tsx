    ...
    <div className="space-y-6">
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center space-y-3 text-muted-foreground">
                      ...
                      <p className="text-base font-medium">No parents found</p>
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 justify-between bg-muted/5 p-4 rounded-xl">
        <div className="flex items-center gap-2 text-sm text-muted-foreground order-2 md:order-1">
          <span className="font-medium text-foreground">{table.getFilteredRowModel().rows.length}</span> of <span className="font-medium text-foreground">{data.length}</span> parents
        </div>
